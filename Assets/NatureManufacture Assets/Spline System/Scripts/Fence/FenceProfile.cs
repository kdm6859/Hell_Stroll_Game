...
namespace NatureManufacture.RAM
{
    ...
    public class FenceProfile : ScriptableObject, IProfile<FenceProfile>
    {
        ...
        [SerializeField] private List<FenceObjectProbability> posts = new List<FenceObjectProbability>();


        [SerializeField] private int postRandomType;

        [SerializeField] private List<FenceObjectProbability> spans = new List<FenceObjectProbability>();
