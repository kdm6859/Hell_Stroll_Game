namespace NatureManufacture.RAM.Editor
{
    ...
    public sealed class RamSplineEditor : Editor
    {
        ...
        private void OnEnable()
        {
            ...
            {
                if (_ramSpline.TerrainManager.NmSpline != _ramSpline.NmSpline)
                    _ramSpline.TerrainManager.NmSpline = _ramSpline.NmSpline;
                TerrainManagerEditor = new TerrainManagerEditor(_ramSpline.TerrainManager);
        ...
        public override void OnInspectorGUI()
        {
            ...
            var btnTxt = new GUIContent(_logo);

            Rect rt = GUILayoutUtility.GetRect(btnTxt, GUI.skin.label, GUILayout.ExpandWidth(false));
            ...
            else if (toolbarNew == 3)
            {
                ...
                if (_ramSpline.BaseProfile.noiseWidth)
                {
                    ...
                    _ramSpline.BaseProfile.noiseSizeWidth = EditorGUILayout.FloatField("Noise Scale Width", _ramSpline.BaseProfile.noiseSizeWidth);
                    EditorGUI.indentLevel--;
                }
        ...
        private void OnSceneGUIInvoke(SceneView sceneView)
        {
            ...
            if (_ramSpline.toolbarInt == 2 && VertexPainterEditor != null && VertexPainterEditor.OnSceneGUI(sceneView))
                return;
