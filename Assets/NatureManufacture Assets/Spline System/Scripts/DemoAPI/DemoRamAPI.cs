    ...
    public class DemoRamAPI : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (terrainPainterData != null)
            {
                ...
                _ramSpline.BaseProfile.PainterData.WorkTerrain = Terrain.activeTerrain;
            }
        }
        ...
        private bool AddPoint()
        {
            ...
            return _ramSpline.NmSpline.MainControlPoints is not {Count: > 1};
        }
        ...
        private void ChangeTerrain()
        {
            ...
            _ramSpline.TerrainManager.CarveTerrain();
            _ramSpline.TerrainManager.PaintTerrain();
            _ramSpline.GenerateSpline();
        }
    }
}